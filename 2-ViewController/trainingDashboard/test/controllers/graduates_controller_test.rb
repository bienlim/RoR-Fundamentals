...
class GraduatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create graduate" do
    assert_difference('Graduate.count') do
      post graduates_url, params: { graduate: { batch_id: @graduate.batch_id, first_name: @graduate.first_name, job_role: @graduate.job_role, last_name: @graduate.last_name } }
    end
  ...
  test "should update graduate" do
    patch graduate_url(@graduate), params: { graduate: { batch_id: @graduate.batch_id, first_name: @graduate.first_name, job_role: @graduate.job_role, last_name: @graduate.last_name } }
